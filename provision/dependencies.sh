...
echo "install.packages(c('brew','Cairo','googleVis','RPostgreSQL','R.utils','yaml','dplyr'), repos='http://cran.rstudio.com/')" | R --vanilla

echo "::::::::::::: POSTGRES :::::::::::::"
apt-get install -y postgresql postgresql-client postgresql-server-dev-9.3 postgresql-contrib pgbouncer

echo "::::::::::::: Apache, etc. :::::::::::::"
apt-get install -y apache2-mpm-prefork apache2-prefork-dev git libapache2-mod-r-base libyaml-tiny-perl
